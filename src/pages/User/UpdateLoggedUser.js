...
export default function UpdateLoggedUser() {
    ...
    useEffect(() => {
        axios.get("https://bpriskassessment.azurewebsites.net/api/users/getbyname", {
            headers: {
    ...
    function handleSubmit(e) {
        ...
        axios.put(`https://bpriskassessment.azurewebsites.net/api/users/${loggedUser.id}`, obj, {
            headers: {
                'Authorization': `Bearer ${user.token}`
            }
        })
    ...
    function handlePasswordForm(e) {
        ...
        axios.post("https://bpriskassessment.azurewebsites.net/api/users/resetpassword", obj, {
            headers: {
                'Authorization': `Bearer ${user.token}`
            }
        })
