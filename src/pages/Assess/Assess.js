...
export default function Assess() {
    ...
    useEffect(() => {
        axios.get("https://elgiz93-001-site2.htempurl.com/api/com/api/com/api/com/api/assessments/getalldata")
    ...
    function handleSpanClick() {
        ...
        axios.post('https://elgiz93-001-site2.htempurl.com/api/com/api/com/api/com/api/assessments/makeassessment', submitValues)
