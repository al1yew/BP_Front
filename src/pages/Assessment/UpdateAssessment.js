...
export default function UpdateAssessment() {
    ...
    useEffect(() => {
        axios.get(`https://elgiz93-001-site2.htempurl.com/api/com/api/assessments/${id}`, {
            headers: {
        ...
        axios.get("https://elgiz93-001-site2.htempurl.com/api/com/api/assessments/getalldata", {
            headers: {
                'Authorization': `Bearer ${user.token}`
            }
        })
    ...
    function handleSpanClick(needToAssess) {
        ...
        axios.put(`https://elgiz93-001-site2.htempurl.com/api/com/api/assessments/${id}`, obj, {
            headers: {
                'Authorization': `Bearer ${user.token}`
            }
        })
